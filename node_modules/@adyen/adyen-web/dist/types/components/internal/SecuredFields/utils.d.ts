...
import { ENCRYPTED_CARD_NUMBER, ENCRYPTED_EXPIRY_DATE, ENCRYPTED_EXPIRY_MONTH, ENCRYPTED_EXPIRY_YEAR, ENCRYPTED_SECURITY_CODE, ENCRYPTED_PWD_FIELD, ENCRYPTED_SECURITY_CODE_3_DIGITS, ENCRYPTED_SECURITY_CODE_4_DIGITS } from './lib/configuration/constants';
/**
 ...
 */
export declare const resolvePlaceholders: (i18n?: Language) => {
    encryptedCardNumber: string;
    encryptedExpiryDate: string;
    encryptedExpiryMonth: string;
    encryptedExpiryYear: string;
    encryptedSecurityCode: string;
    encryptedSecurityCode3digits: string;
    encryptedSecurityCode4digits: string;
